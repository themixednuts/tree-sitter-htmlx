...
fn test_component_quoted_prop() {
    assert_eq!(
        ...
        r#"(document (element (self_closing_tag name: (tag_name) (attribute name: (attribute_name) value: (quoted_attribute_value (attribute_value))))))"#
    );
}
...
#[test]
fn test_element_attributes_after_blank_line_whitespace_matrix() {
    let cases = [
        ("lf_spaces", "\n      \n"),
        ("lf_tabs", "\n\t\t\n"),
        ("lf_mixed", "\n \t  \t\n"),
    ...
    let expected = r#"(document (element (start_tag name: (tag_name) (attribute name: (attribute_name) value: (quoted_attribute_value (attribute_value))) (attribute name: (attribute_name) value: (quoted_attribute_value (attribute_value))) (attribute name: (attribute_name) value: (expression content: (js)))) (text) (element (self_closing_tag name: (tag_name) (attribute name: (attribute_name) value: (expression content: (js))))) (text) (end_tag name: (tag_name))))"#;
...
fn test_component_multiple_props() {
    assert_eq!(
        ...
        r#"(document (element (self_closing_tag name: (tag_name) (attribute name: (attribute_name) value: (quoted_attribute_value (attribute_value))) (attribute name: (attribute_name) value: (expression content: (js))) (attribute (shorthand_attribute content: (js))) (attribute (shorthand_attribute content: (js))))))"#
    );
}
...
fn test_component_let_directive() {
    assert_eq!(
        ...
        "(document (element (start_tag name: (tag_name) (attribute name: (attribute_name (attribute_directive) (attribute_identifier)))) (expression content: (js)) (end_tag name: (tag_name))))"
    );
}
...
fn test_component_let_renamed() {
    assert_eq!(
        ...
        "(document (element (start_tag name: (tag_name) (attribute name: (attribute_name (attribute_directive) (attribute_identifier)) value: (expression content: (js)))) (expression content: (js)) (end_tag name: (tag_name))))"
    );
}
...
fn test_component_let_destructure() {
    assert_eq!(
        ...
        "(document (element (start_tag name: (tag_name) (attribute name: (attribute_name (attribute_directive) (attribute_identifier)) value: (expression content: (js)))) (expression content: (js)) (text) (expression content: (js)) (end_tag name: (tag_name))))"
    );
}
...
fn test_component_with_slot() {
    assert_eq!(
        ...
        r#"(document (element (start_tag name: (tag_name)) (element (start_tag name: (tag_name) (attribute name: (attribute_name) value: (quoted_attribute_value (attribute_value)))) (text) (end_tag name: (tag_name))) (end_tag name: (tag_name))))"#
    );
}
...
fn test_component_deeply_dotted() {
    ...
    assert_eq!(
        ...
        "(document (element (self_closing_tag name: (tag_name object: (tag_member) property: (tag_member) property: (tag_member) property: (tag_member)))))"
    );
}
...
fn test_component_dotted_with_props() {
    assert_eq!(
        ...
        r#"(document (element (self_closing_tag name: (tag_name object: (tag_member) property: (tag_member)) (attribute name: (attribute_name) value: (quoted_attribute_value (attribute_value))))))"#
    );
}
