...
fn test_render_no_args() {
    assert_eq!(
        ...
        "(document (render_tag (block_open) expression: (expression_value content: (js)) (block_close)))"
    );
}
...
fn test_render_in_each() {
    assert_eq!(
        ...
        "(document (each_block (block_open) expression: (expression content: (js)) binding: (pattern content: (js)) (block_close) (render_tag (block_open) expression: (expression_value content: (js)) (block_close)) (block_end (block_open) (block_keyword) (block_close))))"
    );
}
...
fn test_render_in_if() {
    assert_eq!(
        ...
        "(document (if_block (block_open) expression: (expression content: (js)) (block_close) (render_tag (block_open) expression: (expression_value content: (js)) (block_close)) (block_end (block_open) (block_keyword) (block_close))))"
    );
}
