...
fn test_snippet_with_const() {
    assert_eq!(
        ...
        "(document (snippet_block (block_open) name: (snippet_name) parameters: (snippet_parameters parameter: (pattern content: (js))) (block_close) (const_tag (block_open) expression: (expression_value content: (js)) (block_close)) (expression content: (js)) (block_end (block_open) (block_keyword) (block_close))))"
    );
}
