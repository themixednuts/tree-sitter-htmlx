...
fn test_script_with_markup() {
    assert_eq!(
        ...
        "(document (element (start_tag name: (tag_name)) (raw_text) (end_tag name: (tag_name))) (text) (element (start_tag name: (tag_name)) (text) (expression content: (js)) (text) (end_tag name: (tag_name))))"
    );
}
