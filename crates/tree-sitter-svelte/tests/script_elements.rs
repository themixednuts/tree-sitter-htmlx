...
fn test_script_module_attribute() {
    ...
    assert_eq!(
        ...
        "(document (script_element (start_tag (tag_name) (attribute (attribute_name))) (raw_text) (end_tag (tag_name))))"
    );
}
...
fn test_script_module_with_lang() {
    ...
    assert_eq!(
        ...
        r#"(document (script_element (start_tag (tag_name) (attribute (attribute_name)) (attribute (attribute_name) (quoted_attribute_value (attribute_value)))) (raw_text) (end_tag (tag_name))))"#
    );
}
...
fn test_script_with_markup() {
    assert_eq!(
        ...
        "(document (script_element (start_tag (tag_name)) (raw_text) (end_tag (tag_name))) (element (start_tag (tag_name)) (text) (expression content: (js)) (text) (end_tag (tag_name))))"
    );
}
