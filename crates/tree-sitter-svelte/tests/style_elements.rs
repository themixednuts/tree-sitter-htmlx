...
fn test_style_lang_scss() {
    assert_eq!(
        ...
        r#"(document (style_element (start_tag (tag_name) (attribute (attribute_name) (quoted_attribute_value (attribute_value)))) (raw_text) (end_tag (tag_name))))"#
    );
}
...
fn test_style_global_attribute() {
    assert_eq!(
        ...
        "(document (style_element (start_tag (tag_name) (attribute (attribute_name))) (raw_text) (end_tag (tag_name))))"
    );
}
...
fn test_style_global_with_lang() {
    assert_eq!(
        ...
        r#"(document (style_element (start_tag (tag_name) (attribute (attribute_name)) (attribute (attribute_name) (quoted_attribute_value (attribute_value)))) (raw_text) (end_tag (tag_name))))"#
    );
}
