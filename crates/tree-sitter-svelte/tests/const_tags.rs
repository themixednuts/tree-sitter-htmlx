...
fn test_const_simple_assignment() {
    assert_eq!(
        ...
        "(document (if_block expression: (expression content: (js)) (block_close) (const_tag expression: (expression_value content: (js)) (block_close)) (expression content: (js)) (block_end (block_close))))"
    );
}
...
fn test_const_multiple() {
    assert_eq!(
        ...
        "(document (each_block expression: (expression content: (js)) binding: (pattern content: (js)) (block_close) (const_tag expression: (expression_value content: (js)) (block_close)) (const_tag expression: (expression_value content: (js)) (block_close)) (expression content: (js)) (text) (expression content: (js)) (block_end (block_close))))"
    );
}
...
fn test_const_in_component_slot() {
    assert_eq!(
        ...
        "(document (element (start_tag (tag_name) (attribute (attribute_name (attribute_directive) (attribute_identifier)))) (const_tag expression: (expression_value content: (js)) (block_close)) (expression content: (js)) (end_tag (tag_name))))"
    );
}
