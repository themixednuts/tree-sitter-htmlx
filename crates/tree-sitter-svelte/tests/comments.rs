...
fn test_comment_in_if_block() {
    assert_eq!(
        ...
        "(document (if_block expression: (expression content: (js)) (comment) (element (start_tag (tag_name)) (text) (end_tag (tag_name))) (block_end)))"
    );
}
...
fn test_comment_in_each_block() {
    assert_eq!(
        ...
        "(document (each_block expression: (expression content: (js)) binding: (pattern content: (js)) (comment) (element (start_tag (tag_name)) (expression content: (js)) (end_tag (tag_name))) (block_end)))"
    );
}
