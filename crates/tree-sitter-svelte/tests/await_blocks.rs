...
fn test_await_pending_only() {
    assert_eq!(
        ...
        "(document (block (block_start kind: (block_kind) expression: (expression)) pending: (await_pending (text)) (block_end kind: (block_kind))))"
    );
}
...
fn test_await_then_only() {
    assert_eq!(
        ...
        "(document (block (block_start kind: (block_kind) expression: (expression)) (await_branch branch: (block_branch kind: (block_kind) binding: (pattern)) children: (await_branch_children (expression content: (js)))) (block_end kind: (block_kind))))"
    );
}
...
fn test_await_pending_then() {
    assert_eq!(
        ...
        "(document (block (block_start kind: (block_kind) expression: (expression)) pending: (await_pending (text)) (await_branch branch: (block_branch kind: (block_kind) binding: (pattern)) children: (await_branch_children (expression content: (js)))) (block_end kind: (block_kind))))"
    );
}
...
fn test_await_pending_then_catch() {
    assert_eq!(
        ...
        "(document (block (block_start kind: (block_kind) expression: (expression)) pending: (await_pending (text)) (await_branch branch: (block_branch kind: (block_kind) binding: (pattern)) children: (await_branch_children (expression content: (js)))) (await_branch branch: (block_branch kind: (block_kind) binding: (pattern)) children: (await_branch_children (expression content: (js)))) (block_end kind: (block_kind))))"
    );
}
...
fn test_await_then_shorthand() {
    assert_eq!(
        parse("{#await promise then value}{value}{/await}"),
        "(document (block (block_start kind: (block_kind) expression: (expression) shorthand: (block_kind) binding: (pattern)) shorthand_children: (await_branch_children (expression content: (js))) (block_end kind: (block_kind))))"
    );
}
...
fn test_await_then_shorthand_no_binding() {
    ...
    assert_eq!(
        ...
        "(document (block (block_start kind: (block_kind) expression: (expression) shorthand: (block_kind)) (block_end kind: (block_kind))))"
    );
}
...
fn test_await_then_shorthand_with_catch() {
    assert_eq!(
        ...
        "(document (block (block_start kind: (block_kind) expression: (expression) shorthand: (block_kind) binding: (pattern)) shorthand_children: (await_branch_children (expression content: (js))) (await_branch branch: (block_branch kind: (block_kind) binding: (pattern)) children: (await_branch_children (expression content: (js)))) (block_end kind: (block_kind))))"
    );
}
...
fn test_await_with_elements() {
    assert_eq!(
        ...
        "(document (block (block_start kind: (block_kind) expression: (expression)) pending: (await_pending (element (start_tag (tag_name)) (text) (end_tag (tag_name)))) (await_branch branch: (block_branch kind: (block_kind) binding: (pattern)) children: (await_branch_children (element (start_tag (tag_name)) (expression content: (js)) (end_tag (tag_name))))) (await_branch branch: (block_branch kind: (block_kind) binding: (pattern)) children: (await_branch_children (element (start_tag (tag_name)) (expression content: (js)) (end_tag (tag_name))))) (block_end kind: (block_kind))))"
    );
}
...
fn test_await_with_slot() {
    assert_eq!(
        ...
        "(document (block (block_start kind: (block_kind) expression: (expression) shorthand: (block_kind) binding: (pattern)) shorthand_children: (await_branch_children (element (start_tag (tag_name) (attribute (attribute_name) (expression content: (js)))) (text) (end_tag (tag_name)))) (block_end kind: (block_kind))))"
    );
}
