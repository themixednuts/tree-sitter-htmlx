...
fn test_await_pending_only() {
    assert_eq!(
        ...
        "(document (await_block (block_open) expression: (expression content: (js)) (block_close) pending: (await_pending (text)) (block_end (block_open) (block_keyword) (block_close))))"
    );
}
...
fn test_await_then_only() {
    assert_eq!(
        ...
        "(document (await_block (block_open) expression: (expression content: (js)) (block_close) (await_branch branch: (block_open) kind: (branch_kind) binding: (pattern content: (js)) branch: (block_close) children: (await_branch_children (expression content: (js)))) (block_end (block_open) (block_keyword) (block_close))))"
    );
}
...
fn test_await_pending_then() {
    assert_eq!(
        ...
        "(document (await_block (block_open) expression: (expression content: (js)) (block_close) pending: (await_pending (text)) (await_branch branch: (block_open) kind: (branch_kind) binding: (pattern content: (js)) branch: (block_close) children: (await_branch_children (expression content: (js)))) (block_end (block_open) (block_keyword) (block_close))))"
    );
}
...
fn test_await_pending_then_catch() {
    assert_eq!(
        ...
        "(document (await_block (block_open) expression: (expression content: (js)) (block_close) pending: (await_pending (text)) (await_branch branch: (block_open) kind: (branch_kind) binding: (pattern content: (js)) branch: (block_close) children: (await_branch_children (expression content: (js)))) (await_branch branch: (block_open) kind: (branch_kind) binding: (pattern content: (js)) branch: (block_close) children: (await_branch_children (expression content: (js)))) (block_end (block_open) (block_keyword) (block_close))))"
    );
}
...
fn test_await_then_shorthand() {
    assert_eq!(
        parse("{#await promise then value}{value}{/await}"),
        "(document (await_block (block_open) expression: (expression content: (js)) shorthand: (shorthand_kind) binding: (pattern content: (js)) (block_close) shorthand_children: (await_branch_children (expression content: (js))) (block_end (block_open) (block_keyword) (block_close))))"
    );
}
...
fn test_await_then_shorthand_no_binding() {
    ...
    assert_eq!(
        ...
        "(document (await_block (block_open) expression: (expression content: (js)) shorthand: (shorthand_kind) (block_close) (block_end (block_open) (block_keyword) (block_close))))"
    );
}
...
fn test_await_then_shorthand_with_catch() {
    assert_eq!(
        ...
        "(document (await_block (block_open) expression: (expression content: (js)) shorthand: (shorthand_kind) binding: (pattern content: (js)) (block_close) shorthand_children: (await_branch_children (expression content: (js))) (await_branch branch: (block_open) kind: (branch_kind) binding: (pattern content: (js)) branch: (block_close) children: (await_branch_children (expression content: (js)))) (block_end (block_open) (block_keyword) (block_close))))"
    );
}
